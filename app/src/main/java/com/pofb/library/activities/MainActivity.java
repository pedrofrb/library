...
import com.pofb.library.fragments.BookDetailsFragment;
import com.pofb.library.fragments.MainFragment;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, BookListAdapter.ItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Creating a HttpContext and putting on HttpContextBundle
        ...
        try {
            ...
            HttpContextBundle.setContext(localContext);
